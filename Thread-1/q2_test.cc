...
int main(int argc, char *argv[]) {
    ...
    proj1::Instructions instructions = proj1::read_instructrions("data/q2_test_instruction.tsv");
    ...
    bool check = false;
    do {
        proj1::EmbeddingHolder* users1 = new proj1::EmbeddingHolder("data/q2.in");
        proj1::EmbeddingHolder* items1 = new proj1::EmbeddingHolder("data/q2.in");
        for (int i = 0; i < len; i++){
            proj1::run_one_instruction_test(instructions[perm[i]], users1, items1);
        }
        std::cout<<std::endl;
        users1->write_to_stdout();
