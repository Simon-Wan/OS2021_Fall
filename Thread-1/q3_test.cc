...
int main(int argc, char *argv[]) {
    ...
    proj1::Instructions instructions = proj1::read_instructrions("data/q3_test_instruction.tsv");
    ...
    bool check = false;
    do {
        proj1::EmbeddingHolder* users1 = new proj1::EmbeddingHolder("data/q3.in");
        proj1::EmbeddingHolder* items1 = new proj1::EmbeddingHolder("data/q3.in");
        for (int i = 0; i < len; i++){
